...
std::map<uint16_t, std::string> KEYCODE_ID_TABLE = {
    ...
    {QK_TAP_REPEAT_TOGGLE, "QK_TAP_REPEAT_TOGGLE"},
    {QK_KEY_LOCK_TOGGLE, "QK_KEY_LOCK_TOGGLE"},
    ...
    {RGB_CYCLE_MODIFIERS, "RGB_CYCLE_MODIFIERS"},
    {RGB_CYCLE_UNDERGLOW, "RGB_CYCLE_UNDERGLOW"},
    {RGB_CYCLE_KEYLIGHTS, "RGB_CYCLE_KEYLIGHTS"},
    {RGB_CYCLE_INDICATORS, "RGB_CYCLE_INDICATORS"},
